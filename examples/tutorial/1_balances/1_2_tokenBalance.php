...
require_once '../viewHeader.html'; // Don't forget to configure your database in config.php
    ...
    /* In this example we are going to query token balance from a datasource (BlockDaemonDataSource)
    ...
    */
    ...
    echoSubTitle("Loading balance from BlockDaemon ");
    echoExplanations("We are loading balance from wallet : $testEthAddress using BlockDaemon as datasource");
    ...
    $myTestEthereumAddress->setDataSource(new \CsCannon\Blockchains\Ethereum\DataSource\BlockDaemonDataSource());
    ...
    echoExplanations("We save the balance we got from BlockDaemon to our local database (datagraph)");
