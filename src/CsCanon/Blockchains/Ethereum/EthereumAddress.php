...
use App\Blockchains\BlockchainEvent;
...
class EthereumAddress extends BlockchainAddress
{
    ...
    public function getBalance(){
       ...
       // dd($this->getAddress());
        ...
        //Xchain
        $foreignAdapter = new ForeignEntityAdapter("https://api.opensea.io/api/v1/assets/?format=json&order_by=current_price&order_direction=a&owner=".$this->getAddress(),'assets',app('Sandra')->getSandra());
        ...
        foreach ($foreignAdapter->entityArray as $entity){
          ...
          //  $assetEntity = new Asset($random,$entity->entityRefs,$foreignAdapter,$entity->entityId,$assetFactory->entityReferenceContainer,$assetFactory->entityContainedIn,app('Sandra')->getSandra());
