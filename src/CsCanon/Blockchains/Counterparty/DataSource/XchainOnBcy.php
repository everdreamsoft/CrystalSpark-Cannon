...
namespace CsCanon\Blockchains\Counterparty\DataSource;

use CsCanon\Blockchains\Blockchain;
use CsCanon\Blockchains\BlockchainDataSource;
...
class XchainOnBcy extends BlockchainDataSource
{
    ...
    public function getEvents($contract,$batchMax=1000,$offset=0):ForeignEntityAdapter
    {
        ...
        $blockSucker = new PdoConnexionWrapper('eds.alwaysdata.net', 'eds2_counterparty', 'eds2', 'staffZ4Vm');
